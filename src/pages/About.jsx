      ...
      <div className=" flex w-full h-full gap-[5%]">
        ...
        <div className=" w-[70%] p-10">
          <div className=" w-full flex gap-[5%]">
            <div className=" cardBg rounded-md secondTextColor w-[40%] p-5 flex flex-col gap-5 h-full">
            ...
            <div className="cardBg w-[55%] h-full p-10 flex flex-col gap-5 items-start justify-start">
              <h1 className=' font-semibold text-xl text-[#fefefe]'>Here will be the roadmap of my experiences and other</h1>
              <Roadmap />
            </div>
          </div>
        </div>
